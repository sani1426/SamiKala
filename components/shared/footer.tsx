...
const Footer = () => {
  return (
    <footer className="bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-slate-100 border-t border-t-slate-800 dark:border-t-slate-800 py-12 px-10">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
            <div>
                ...
                <p className="font-medium text-sm text-gray-600 dark:text-gray-400 mb-2">ثبت نام کنید و 10 درصد تخفیف بگیرید</p>
                <form className="flex">
